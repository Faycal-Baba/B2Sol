...
public class GrammarCellsSubstituteMenu_PayableFunctionDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_PayableFunctionDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ul1kmg_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "PayableFunctionDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ul1kmg_a extends GrammarCellsSubstituteMenuPart {
    @Override
