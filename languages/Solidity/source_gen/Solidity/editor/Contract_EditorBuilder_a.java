...
/*package*/ class Contract_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contractPartsListHandler_srzqn1_a2a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_contractParts");
    Style style = new StyleImpl();
  ...
  private static class contractPartsListHandler_srzqn1_a2a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contractPartsListHandler_srzqn1_a2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.contractParts$lFDN;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ContractPart$Sv;
    }
    ...
    public SNode nodeFactory() {
      return SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xf72d32028a4541adL, 0xbb612369f7191040L, 0x6d3985c698ca4933L, "Solidity.structure.EmptyLine"));
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contractPartsListHandler_srzqn1_a2a.this.getNode(), LINKS.contractParts$lFDN));
      try {
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_srzqn1_d0");
    Style style = new StyleImpl();
