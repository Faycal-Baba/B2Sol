...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(Platform))==(startingBid_,endAt_);
  Inherited_List_Constants(Machine(Platform))==(?);
  List_Constants(Machine(Platform))==(startingBid_,endAt_)
END
&
THEORY ListSetsX IS
...
THEORY ListPropertiesX IS
  ...
  List_Properties(Machine(Platform))==(startingBid_: NAT & endAt_: NAT)
END
&
...
THEORY ConstantsEnvX IS
  Constants(Machine(Platform)) == (Type(startingBid_) == Cst(btype(INTEGER,?,?));Type(endAt_) == Cst(btype(INTEGER,?,?)))
END
&
