...
public class GrammarCellsSubstituteMenu_IfStatement extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IfStatement() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_7nxlaz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IfStatement", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_7nxlaz_a extends GrammarCellsSubstituteMenuPart {
    @Override
