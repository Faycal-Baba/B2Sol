...
THEORY ListPropertiesX IS
  ...
  List_Properties(Machine(Solidity_Types))==(USERS = ADDRESS-{THIS} & init_msg_sender: ADDRESS & init_msg_value: NAT & init_block_timestamp: NAT & BYTES: FIN(INTEGER) & not(BYTES = {}) & ADDRESS: FIN(INTEGER) & not(ADDRESS = {}))
END
&
