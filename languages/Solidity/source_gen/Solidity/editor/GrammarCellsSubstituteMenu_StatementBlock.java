...
public class GrammarCellsSubstituteMenu_StatementBlock extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StatementBlock() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_psifr1_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "StatementBlock", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_psifr1_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.StatementBlock$7Q;
    }
  }
