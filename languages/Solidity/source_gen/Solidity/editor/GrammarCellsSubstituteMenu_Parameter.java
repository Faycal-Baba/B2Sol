...
public class GrammarCellsSubstituteMenu_Parameter extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Parameter() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_sjajnq_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Parameter", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_sjajnq_a extends GrammarCellsSubstituteMenuPart {
    @Override
