...
public class GrammarCellsSubstituteMenu_FunctionDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_FunctionDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_6gy5kj_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "FunctionDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_6gy5kj_a extends GrammarCellsSubstituteMenuPart {
    @Override
