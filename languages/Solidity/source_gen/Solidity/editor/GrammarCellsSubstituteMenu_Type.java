...
public class GrammarCellsSubstituteMenu_Type extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Type() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8hatkb_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Type", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8hatkb_a extends GrammarCellsSubstituteMenuPart {
    @Override
