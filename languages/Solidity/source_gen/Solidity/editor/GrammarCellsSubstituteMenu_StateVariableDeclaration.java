...
public class GrammarCellsSubstituteMenu_StateVariableDeclaration extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StateVariableDeclaration() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_hos1zo_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "StateVariableDeclaration", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_hos1zo_a extends GrammarCellsSubstituteMenuPart {
    @Override
