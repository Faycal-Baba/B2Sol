...
public class GrammarCellsSubstituteMenu_Contract extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Contract() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cw94if_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Contract", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cw94if_a extends GrammarCellsSubstituteMenuPart {
    @Override
